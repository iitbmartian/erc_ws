...
public:
  ...
  /**
   * @brief Set boundary markers and directional preferences
   */
  void setBoundaryInfo(const std::map<int, geometry_msgs::msg::Point>& markers,
...
protected:
  ...
  /**
   * @brief computes frontier cost with directional bias, boundary avoidance, and backtracking penalty
...
private:
  ...
  // Boundary awareness and directional exploration
  std::map<int, geometry_msgs::msg::Point> boundary_markers_;
  double boundary_distance_;
  geometry_msgs::msg::Point preferred_direction_;
